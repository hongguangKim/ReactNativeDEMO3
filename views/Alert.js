...
const [aWidth, aHeight] = [width-20, 214];
const [left, top] = [0, 0];
    ...
    if(this.state.hide){
      ...
      return (
        <View style={styles.container} >
          <Animated.View style={ styles.mask } onPress={this.iknow.bind(this)}>
            <TouchableOpacity onPress={this.iknow.bind(this)}   style={{flex:1}} />
          </Animated.View>
          <Animated.View style={[styles.tip , {transform: [{
                translateY: this.state.offset.interpolate({
                 inputRange: [0, 1],
                 outputRange: [height, (height-aHeight -94)]
                }),
              }]
            }]}>
